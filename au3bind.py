...
class AutoItX3():
    ...
    def __init__(self):
        ...
        self.AU3_ClipGet = lambda szClip, nBufSize: self.au3.AU3_ClipGet(szClip, nBufSize)
        ...
        self.AU3_ControlCommand = lambda szTitle, szText, szControl, szCommand, szExtra, szResult, nBufSize: self.au3.AU3_ControlCommand(szTitle, szText, szControl, szCommand, szExtra, szResult, nBufSize)
        ...
        self.AU3_ControlListView = lambda szTitle, szText, szControl, szCommand, szExtra1, szExtra2, szResult, nBufSize: self.au3.AU3_ControlListView(szTitle, szText, szControl, szCommand, szExtra1, szExtra2, szResult, nBufSize)
        ...
        self.AU3_ControlGetFocus = lambda szTitle, szText, szControlWithFocus, nBufSize: self.au3.AU3_ControlGetFocus(szTitle, szText, szControlWithFocus, nBufSize)
        ...
        self.AU3_ControlGetHandle = lambda szTitle, szText, szControl, szRetText, nBufSize: self.au3.AU3_ControlGetHandle(szTitle, szText, szControl, szRetText, nBufSize)
        ...
        self.AU3_ControlGetText = lambda szTitle, szText, szControl, szControlText, nBufSize: self.au3.AU3_ControlGetText(szTitle, szText, szControl, szControlText, nBufSize)
        ...
        self.AU3_ControlTreeView = lambda szTitle, szText, szControl, szCommand, szExtra1, szExtra2, szResult, nBufSize: self.au3.AU3_ControlTreeView(szTitle, szText, szControl, szCommand, szExtra1, szExtra2, szResult, nBufSize)
        ...
        self.AU3_DriveMapAdd = lambda szDevice, szShare, nFlags, szUser, szPwd, szResult, nBufSize: self.au3.AU3_DriveMapAdd(szDevice, szShare, nFlags, szUser, szPwd, szResult, nBufSize)
        ...
        self.AU3_DriveMapGet = lambda szDevice, szMapping, nBufSize: self.au3.AU3_DriveMapGet(szDevice, szMapping, nBufSize)
        ...
        self.AU3_IniRead = lambda szFilename, szSection, szKey, szDefault, szValue, nBufSize: self.au3.AU3_IniRead(szFilename, szSection, szKey, szDefault, szValue, nBufSize)
        ...
        self.AU3_RegEnumKey = lambda szKeyname, nInstance, szResult, nBufSize: self.au3.AU3_RegEnumKey(szKeyname, nInstance, szResult, nBufSize)

        self.au3.AU3_RegEnumVal.restype = None
        self.au3.AU3_RegEnumVal.argtypes = (c_wchar_p, c_long, c_wchar_p, c_int, )
        self.AU3_RegEnumVal = lambda szKeyname, nInstance, szResult, nBufSize: self.au3.AU3_RegEnumVal(szKeyname, nInstance, szResult, nBufSize)

        self.au3.AU3_RegRead.restype = None
        self.au3.AU3_RegRead.argtypes = (c_wchar_p, c_wchar_p, c_wchar_p, c_int, )
        self.AU3_RegRead = lambda szKeyname, szValuename, szRetText, nBufSize: self.au3.AU3_RegRead(szKeyname, szValuename, szRetText, nBufSize)
        ...
        self.AU3_StatusbarGetText = lambda szTitle, szText, nPart, szStatusText, nBufSize: self.au3.AU3_StatusbarGetText(szTitle, szText, nPart, szStatusText, nBufSize)
        ...
        self.AU3_WinGetClassList = lambda szTitle, szText, szRetText, nBufSize: self.au3.AU3_WinGetClassList(szTitle, szText, szRetText, nBufSize)
        ...
        self.AU3_WinGetHandle = lambda szTitle, szText, szRetText, nBufSize: self.au3.AU3_WinGetHandle(szTitle, szText, szRetText, nBufSize)
        ...
        self.AU3_WinGetProcess = lambda szTitle, szText, szRetText, nBufSize: self.au3.AU3_WinGetProcess(szTitle, szText, szRetText, nBufSize)
        ...
        self.AU3_WinGetText = lambda szTitle, szText, szRetText, nBufSize: self.au3.AU3_WinGetText(szTitle, szText, szRetText, nBufSize)

        self.au3.AU3_WinGetTitle.restype = None
        self.au3.AU3_WinGetTitle.argtypes = (c_wchar_p, c_wchar_p, c_wchar_p, c_int, )
        self.AU3_WinGetTitle = lambda szTitle, szText, szRetText, nBufSize: self.au3.AU3_WinGetTitle(szTitle, szText, szRetText, nBufSize)
